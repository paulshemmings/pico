...
import razor.android.lib.core.helpers.MapHelper;
...
public class MapOverlayWrapper extends ItemizedOverlay<ViewModelOverlayItem> implements IMapOverlayWrapper {
	...
	/* (non-Javadoc)
	 * @see com.bbconnect.lib.wrappers.IMapOverlayWrapper#addItem(double, double, java.lang.String, java.lang.String)
	 */
	public int addItem(double lat, double lon, ICoreViewModel model){
